...
?>
<script>
Phx.vista.Materiallt=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.Materiallt.superclass.constructor.call(this,config);
		this.init();
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'mtlt.materiallt',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},	
		{
			config:{
				...
				type:'NumberField',
				filters:{pfiltro:'mtlt.peso',type:'numeric'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'mtlt.estado_reg',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'Field',
				filters:{pfiltro:'mtlt.id_usuario_ai',type:'numeric'},
				id_grupo:1,
				grid:false,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'mtlt.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'mtlt.usuario_ai',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'mtlt.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		}
	...
	tam_pag:50,	
	title:'Material LT',
	ActSave:'../../sis_SINEX/control/Materiallt/insertarMateriallt',
	ActDel:'../../sis_SINEX/control/Materiallt/eliminarMateriallt',
	ActList:'../../sis_SINEX/control/Materiallt/listarMateriallt',
	...
	tabsouth:[
		{
			url:'../../../sis_SINEX/vista/materialpreciolt/Materialpreciolt.php',
			title:'Precio',
			height:'50%',
			cls:'Materialpreciolt'
		},
		{
			url:'../../../sis_SINEX/vista/materialcantidadlt/Materialcantidadlt.php',
			title:'Cantidad',
			height:'50%',
			cls:'Materialcantidadlt'
		}		
	]	
	}
)
