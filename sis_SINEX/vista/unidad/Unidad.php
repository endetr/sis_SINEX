...
?>
<script>
Phx.vista.Unidad=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.Unidad.superclass.constructor.call(this,config);
		this.init();
	...
	Atributos:[
		...
		},		
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'uni.unidadabrev',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
	...
	tam_pag:50,	
	title:'Unidad',
	ActSave:'../../sis_SINEX/control/Unidad/insertarUnidad',
	ActDel:'../../sis_SINEX/control/Unidad/eliminarUnidad',
	ActList:'../../sis_SINEX/control/Unidad/listarUnidad',
	id_store:'id_unidad',
	fields: [
