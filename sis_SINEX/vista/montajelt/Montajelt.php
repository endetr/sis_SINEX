...
?>
<script>
Phx.vista.Montajelt=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.Montajelt.superclass.constructor.call(this,config);
		this.init();
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'monlt.montajelt',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},
		{
			config:{
				...
				type:'NumberField',
				filters:{pfiltro:'valormontajelt',type:'numeric'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},			
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'monlt.estado_reg',type:'string'},
				id_grupo:1,
				grid:false,
				form:false
		},		
		{
			config:{
				...
				type:'Field',
				filters:{pfiltro:'monlt.id_usuario_ai',type:'numeric'},
				id_grupo:1,
				grid:false,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'monlt.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'monlt.usuario_ai',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'monlt.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		}
	...
	ActSave:'../../sis_SINEX/control/Montajelt/insertarMontajelt',
	ActDel:'../../sis_SINEX/control/Montajelt/eliminarMontajelt',
	ActList:'../../sis_SINEX/control/Montajelt/listarMontajelt',
	id_store:'id_montajelt',
	fields: [
		{name:'id_montajelt', type: 'numeric'},
		{name:'id_unidad', type: 'numeric'},
		{name:'estado_reg', type: 'string'},
		{name:'montajelt', type: 'string'},
	...
	tabsouth:[
		{
			url:'../../../sis_SINEX/vista/montajepreciolt/Montajepreciolt.php',
			title:'Precio',
			height:'50%',
			cls:'Montajepreciolt'
		},
		{
			url:'../../../sis_SINEX/vista/montajecantidadlt/Montajecantidadlt.php',
			title:'Cantidad',
			height:'50%',
			cls:'Montajecantidadlt'
		}
	]
	}
)
