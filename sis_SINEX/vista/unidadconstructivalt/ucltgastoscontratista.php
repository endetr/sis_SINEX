...
?>
<script>
Phx.vista.ucltgastoscontratista=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.ucltgastoscontratista.superclass.constructor.call(this,config);
		this.init();
	...
	tam_pag:50,	
	title:'Gastos Contratista',
	ActList:'../../sis_SINEX/control/Unidadconstructivalt/listarGastoscontratistalt',
	...
	{
		Phx.vista.ucltgastoscontratista.superclass.loadValoresIniciales.call(this);
