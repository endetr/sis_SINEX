   ...
   --Comunicaciones
	...
	SELECT		uclt.id_unidadconstructivalt,
				...
				CAST(CASE
					...
					WHEN ucltitem.id_item = 37 AND uclt.id_unidadconstructivalt = 15 AND uclt.id_configuracionlt = 1 THEN uclt.longitud/0.5*1
					WHEN ucltitem.id_item = 37 AND uclt.id_unidadconstructivalt = 15 AND uclt.id_configuracionlt <> 1 THEN uclt.longitud/0.5*2					
	...
	WHERE	ttempeqmate.id_unidadconstructivalt IN (11,12,13,14,15) AND
